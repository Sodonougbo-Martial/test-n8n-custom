...
##############################
# Use Node.js towSwS4bV1XE8INdWP extract the package name from package.json.
...
TARGET_DIR="/var/lib/docker/volumes/self-hosted-ai-starter-kit_n8n_storage/_data/custum/$PACKAGE_NAME"
